...
set :repo_url, "git@bitbucket.org:UIUCLibrary/uiuc-vireo-4.git"
...
set :deploy_to, "/services/ideals-etd/src/vireo4"
...
namespace :deploy do
    ...
    task :buildwar do 
      ...
      on roles(:app) do
        ...
        execute "ln -s #{deploy_to}/shared/application.yaml #{deploy_to}/current/src/main/resources/application.yaml"
